package com.zooka.uasricardohadirijson;
...
public class AsyncInvokeURLTask extends AsyncTask<Void, Void, String> {
    public String mNoteItWebUrl = "kodowski.xyz";
    ...
    // IP Server
    public String url_server ="http://kodowski.xyz/contact/";
    ...
    protected String doInBackground(Void... params) {
        ...
        //Create a new HTTP Client and PostHeader
